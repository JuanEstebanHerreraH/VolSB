          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                _Badge(
                  label: 'AVRCP',
                  active: device.avrcpSupported,
                  cs: cs,
                ),
                _Badge(
                  label: 'Vol. Absoluto',
                  active: device.absoluteVolumeSupported,
                  cs: cs,
                ),
                _Badge(
                  label: device.volumeSynced ? 'Vol. Sincronizado' : 'Vol. Independiente',
                  active: device.volumeSynced,
                  cs: cs,
                ),
                _Badge(
                  label: device.profileType,
                  active: true,
                  cs: cs,
                  neutral: true,
                ),
